...
def test_get_championships_ranks(test_scores, test_championship, unauthorized_user, authorized_user, moderator_user, banned_user):
    assert mock_get_championships_ranks(unauthorized_user, test_championship) == status.HTTP_200_OK
...
def test_get_events_ranks(test_scores, test_upcoming_events, test_passed_events, unauthorized_user, authorized_user, moderator_user, banned_user):
    upcoming_event = random.choice(test_upcoming_events)
    passed_event = random.choice(test_passed_events)
    assert mock_get_events_ranks(unauthorized_user, passed_event) == status.HTTP_200_OK
...
def test_get_records_sessions_ranks(test_championship, test_scores, unauthorized_user, authorized_user, moderator_user, banned_user):
    assert mock_get_records_sessions_ranks(unauthorized_user, test_championship) == status.HTTP_200_OK
